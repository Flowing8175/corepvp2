...
public class CoreManager {
    ...
    public void spawnCores() {
        ...
        Location blueCoreLocation = new Location(plugin.getServer().getWorlds().get(0), blueX, 0, blueZ);
        blueCoreLocation.setY(blueCoreLocation.getWorld().getHighestBlockYAt(blueCoreLocation) + 2);
        ...
        Location redCoreLocation = new Location(plugin.getServer().getWorlds().get(0), redX, 0, redZ);
        redCoreLocation.setY(redCoreLocation.getWorld().getHighestBlockYAt(redCoreLocation) + 2);
